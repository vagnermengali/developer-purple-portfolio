...
const ScrollNavigation = () => {
    ...
    return (
        <>
            {router.pathname === "/" && (
                <div className="fixed flex items-center flex-col justify-center w-8 sm:w-10 h-full lg:w-10 lg:h-[8.25rem] left-1/2 lg:left-10 z-50 top-[90%] sm:top-[93%] lg:top-[40%] -rotate-90 lg:rotate-0 -translate-x-2/4 -translate-y-2/4 lg:translate-x-0 lg:translate-y-0">
