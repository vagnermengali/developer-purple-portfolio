...
const Passion = () => {
  return (
    <div className="w-full h-min flex justify-center items-center flex-col p-t-[5.625rem] pb-10">
      <div className="w-[85%] sm:w-[70%] lg:w-[93%] flex-col lg:flex-row gap-8 sm:gap-4 lg:gap-10 flex items-center justify-center h-full">
        <div className="w-full h-full flex items-center justify-start flex-col gap-6 lg:gap-[1.6rem]">
          <Icon id="Computer" className="relative w-[3.75rem] min-h-[3.75rem] sm:w-[5.625rem] sm:min-h-[5.625rem] lg:w-[9.375rem]" />
        ...
        <div className="w-full h-full flex items-center justify-start flex-col gap-6 lg:gap-[1.6rem]">
          <Icon id="Chip" className="relative w-[9.375rem] min-h-[9.375rem]" />
        ...
        <div className="w-full h-full flex items-center justify-start flex-col gap-6 lg:gap-[1.6rem]">
          <Icon id="Book" className="relative w-[9.375rem] min-h-[9.375rem]" />
